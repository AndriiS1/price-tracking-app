...
public class AuthenticationController : ControllerBase
{
    ...
    public AuthenticationController(IUnitOfWork unitOfWork, IJwtService jwtService, IHashService hashService,
    ...
    public IActionResult LoginController(LoginDto loginData)
    {
        ...
        var user = _unitOfWork.Users.SingleOrDefault(u =>
            u.Password == _hashService.GetHash(loginData.Password) && u.Email == loginData.Email);
        if (user != null)
        {
